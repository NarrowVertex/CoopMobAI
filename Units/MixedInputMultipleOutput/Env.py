...
class Env:
    ...
    def step(self, action):
        ...
        # reward = (old_distance - new_distance) / 8 - 0.01     # 0.0025 ~ -0.0225
        # reward = (self.trace_map[int(after_agent_pos[1])][int(after_agent_pos[0])] -
        #          self.trace_map[int(self.agent_pos[1])][int(self.agent_pos[0])]) * 4 - 0.01
        # looking_pos = [angled_cos(direction[0]), angled_sin(direction[1])]
        # current_value = self.trace_map[int(self.agent_pos[1])][int(self.agent_pos[0])]
        # new_value = self.trace_map[int(looking_pos[1])][int(looking_pos[0])]
